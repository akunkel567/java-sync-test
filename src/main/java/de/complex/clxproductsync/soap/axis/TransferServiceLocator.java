...
public class TransferServiceLocator extends org.apache.axis.client.Service implements de.complex.clxproductsync.soap.axis.TransferService {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.complex.clxproductsync.soap.axis.TransferPort.class.isAssignableFrom(serviceEndpointInterface)) {
                de.complex.clxproductsync.soap.axis.TransferBindingStub _stub = new de.complex.clxproductsync.soap.axis.TransferBindingStub(new java.net.URL(TransferPort_address), this);
                _stub.setPortName(getTransferPortWSDDServiceName());
                return _stub;
            }
        }
