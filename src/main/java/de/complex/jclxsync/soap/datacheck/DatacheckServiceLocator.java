...
public class DatacheckServiceLocator extends org.apache.axis.client.Service implements de.complex.jclxsync.soap.datacheck.DatacheckService {
    ...
    public de.complex.jclxsync.soap.datacheck.DatacheckPort getDatacheckPort() throws javax.xml.rpc.ServiceException {
    ...
    public de.complex.jclxsync.soap.datacheck.DatacheckPort getDatacheckPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.complex.jclxsync.soap.datacheck.DatacheckBindingStub _stub = new de.complex.jclxsync.soap.datacheck.DatacheckBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.complex.jclxsync.soap.datacheck.DatacheckPort.class.isAssignableFrom(serviceEndpointInterface)) {
                de.complex.jclxsync.soap.datacheck.DatacheckBindingStub _stub = new de.complex.jclxsync.soap.datacheck.DatacheckBindingStub(new java.net.URL(DatacheckPort_address), this);
                _stub.setPortName(getDatacheckPortWSDDServiceName());
                return _stub;
            }
        }
