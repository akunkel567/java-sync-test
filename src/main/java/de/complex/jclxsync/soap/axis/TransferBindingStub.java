...
public class TransferBindingStub extends org.apache.axis.client.Stub implements de.complex.jclxsync.soap.axis.TransferPort {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "SnjobIn"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:Transfer", "SnjobIn"), de.complex.jclxsync.soap.axis.SnjobIn.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnClass(de.complex.jclxsync.soap.axis.SoapAnswer[].class);
        ...
        oper.setReturnClass(de.complex.jclxsync.soap.axis.Snjobweb[].class);
        ...
        oper.setReturnClass(de.complex.jclxsync.soap.axis.XmlOut.class);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "password"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "FiledataIn"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:Transfer", "FiledataIn"), de.complex.jclxsync.soap.axis.FiledataIn.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:Transfer", "SoapAnswer"));
        oper.setReturnClass(de.complex.jclxsync.soap.axis.SoapAnswer.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "SoapAnswer"));
    ...
    public TransferBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = de.complex.jclxsync.soap.axis.FiledataIn.class;
            ...
            cachedSerQNames.add(qName);
            cls = de.complex.jclxsync.soap.axis.Returnnok.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.complex.jclxsync.soap.axis.SnjobIn.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.complex.jclxsync.soap.axis.Snjobweb.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.complex.jclxsync.soap.axis.SoapAnswer.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.complex.jclxsync.soap.axis.XmlOut.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {login, password, snjobIn, xml});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (de.complex.jclxsync.soap.axis.SoapAnswer[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.complex.jclxsync.soap.axis.SoapAnswer[]) org.apache.axis.utils.JavaUtils.convert(_resp, de.complex.jclxsync.soap.axis.SoapAnswer[].class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {login, password, new java.lang.Integer(limit)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (de.complex.jclxsync.soap.axis.Snjobweb[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.complex.jclxsync.soap.axis.Snjobweb[]) org.apache.axis.utils.JavaUtils.convert(_resp, de.complex.jclxsync.soap.axis.Snjobweb[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {login, password, new java.lang.Long(snjobwebid)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (de.complex.jclxsync.soap.axis.XmlOut) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.complex.jclxsync.soap.axis.XmlOut) org.apache.axis.utils.JavaUtils.convert(_resp, de.complex.jclxsync.soap.axis.XmlOut.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
