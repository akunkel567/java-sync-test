...
import de.complex.jclxsync.eventhandler.dbevent.WebsyncEventManager;
import de.complex.jclxsync.eventhandler.fileevent.FileEventManager;
import de.complex.jclxsync.eventhandler.socketevent.SocketEventManager;
...
import de.complex.jclxsync.job.SpoolcheckUploadJob;
...
public class MainApp extends Thread {
	...
	public int snModeRun(String[] args, boolean setDebug) {
		...
		try {
			this.versionString = loadTextResource("de.complex.jclxsync.resources", "version.info");
