...
public class TablesyncServiceLocator extends org.apache.axis.client.Service implements de.complex.clxproductsync.soap.tablesync.TablesyncService {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.complex.clxproductsync.soap.tablesync.TablesyncPort.class.isAssignableFrom(serviceEndpointInterface)) {
                de.complex.clxproductsync.soap.tablesync.TablesyncBindingStub _stub = new de.complex.clxproductsync.soap.tablesync.TablesyncBindingStub(new java.net.URL(TablesyncPort_address), this);
                _stub.setPortName(getTablesyncPortWSDDServiceName());
                return _stub;
            }
